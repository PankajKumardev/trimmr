...
function LandingPage() {
  ...
  return (
    <div className='flex flex-col items-center'>
      <h2 className="my-10 sm:my-16 text-5xl sm:text-6xl lg:text-7xl text-[#176B87] text-center font-extrabold">
        <h1 className='text-[#5B9A8B]'> Where long URLs</h1> meet their match!⚡️
      </h2>
      ...
      <form className="sm:h-14 flex flex-col sm:flex-row w-full md:w-2/4 gap-2 m-10" onSubmit={handleShorten}>
        <Input
          ...
          className="md:h-full flex-1 py-2 px-2 md:py-4 placeholder:text-indigo-400 text-white bg-[#0F172A]"
        />
      ...
      <p className="mt-2 text-slate-400 text-center text-xl font-semibold mb-10">
        Simplify your URLs and make sharing easy.
      </p>

      <div className="opacity-70 mt-12 justify-center flex items-center flex-col text-slate-200">
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-mouse animate-bounce">
      ...
      <div className='mt-20 w-full h-full mb-20'>
        <Accordion type="multiple" collapsible className="w-full md:px-11">
          <AccordionItem value="item-1">
            <AccordionTrigger>
              What is the Trimrr URL shortener?
            </AccordionTrigger>
            <AccordionContent>
